...
public:
  ...
  RC insert_record(Trx *trx, const char *dbname, const char *relation_name,
                   int tuple_num, int value_num, Value *values);
  ...
  RC update_record(Trx *trx, const char *dbname, const char *relation_name,
                   const char *attribute_name, Value *value, int condition_num,
                   Condition *conditions, int *updated_count);
