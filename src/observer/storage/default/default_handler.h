...
public:
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, int value_num, Value *values);
   ...
   * @return
   */
  RC update_record(Trx * trx, const char *dbname, const char *relation_name, const char *attribute_name, Value *value,
